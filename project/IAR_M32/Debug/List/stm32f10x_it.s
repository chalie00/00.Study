...
??TIM2_IRQHandler_3:
        MOVS     R1,#+1
        LDR.W    R0,??DataTable15_1  ;; 0x40011000
...
??TIM2_IRQHandler_17:
        ...
        LDRB     R0,[R0, #+18]
        CMP      R0,#+0
        BNE.N    ??TIM2_IRQHandler_18
        LDR.W    R0,??DataTable15_2
        LDRB     R0,[R0, #+19]
        CMP      R0,#+0
        BNE.N    ??TIM2_IRQHandler_19
        LDR.W    R0,??DataTable15_2
        LDRB     R0,[R0, #+20]
        CMP      R0,#+0
        BNE.N    ??TIM2_IRQHandler_19
...
TIM3_IRQHandler:
        PUSH     {R7,LR}
        MOVS     R1,#+1
        LDR.W    R0,??DataTable19_1  ;; 0x40000400
        BL       TIM_GetITStatus
        CMP      R0,#+0
...
??Boot_Status_Data_Trans_2:
        ...
        LDR.W    R0,??DataTable19_5  ;; 0x40013800
        BL       USART_SendData
        LDR.W    R0,??DataTable19_3
        MOVS     R1,#+0
        STRB     R1,[R0, #+0]
...
USART1_IRQHandler:
        ...
        MOVS     R4,#+0
        MOVW     R1,#+1574
        LDR.N    R0,??DataTable19_5  ;; 0x40013800
...
USART2_IRQHandler:
        ...
        MOVS     R5,#+0
        MOVW     R1,#+1574
        LDR.W    R0,??DataTable26  ;; 0x40004400
        BL       USART_GetITStatus
        CMP      R0,#+0
...
USART3_IRQHandler:
        ...
        MOVS     R5,#+0
        MOVW     R1,#+1574
        LDR.W    R0,??DataTable26_1  ;; 0x40004800
        BL       USART_GetITStatus
        CMP      R0,#+0
...
UART4_IRQHandler:
        ...
        MOVS     R5,#+0
        MOVW     R1,#+1574
        LDR.W    R0,??DataTable28_1  ;; 0x40004c00
        BL       USART_GetITStatus
        CMP      R0,#+0
...
UART5_IRQHandler:
        ...
        MOVS     R5,#+0
        MOVW     R1,#+1574
        LDR.N    R0,??DataTable28_4  ;; 0x40005000
        BL       USART_GetITStatus
        CMP      R0,#+0
